            ...
            <div className="About-border">
                ...
                <div className="About-profile-left">
                    ...
                    <div className="About-profile-left-description-container">
                        ...
                        <p className="About-profile-left-description-resume">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
                <div className="About-profile-right">
                    ...
                    <div className="About-profile-right-description-container">
                        ...
                        <p className="About-profile-right-description-resume">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
                <div className="About-profile-left">
